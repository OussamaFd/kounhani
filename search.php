...
<div class="container_NHDRSFW" style="background:#fff;">
    <div class="container_976479">
		...
		<?php			  
		//Select 
		$select = mysqli_query($connectDB,"SELECT * FROM post WHERE (CONVERT(title USING utf8) LIKE '%$box%') ORDER BY id DESC ");
		...
		<div class="post">
			...
			<div class="text">
				...
				<div class="some_information">
					...
					<a href="profile.php?p='.$fitvb['id'].'" style="text-decoration:none;"><p>'.$fitvb['fname'].' '.$fitvb['lname'].'</p></a>
				</div>  
			</div>
		</div>
		';
			...
			echo'<p style="text-align:center;font-weight:bold;font-size:25px;color:#ccc;">نتائج البحث عن ('.$box.') 0</p><br/><a href="index.php">الصفحة الرئيسية</a>';
